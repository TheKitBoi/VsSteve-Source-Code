		...
		switch(SONG.stage)
		{
			...
			case 'notch':
			{
					...
					add(bgStreet);
			 		...
			 		alex = new FlxSprite(-840, 150);
					alex.frames = Paths.getSparrowAtlas('temple/alexBG');
					alex.animation.addByPrefix('idle', 'alexBG Idle', 24, false);
					alex.y -= 300;
					if(FlxG.save.data.distractions)
					alex.setGraphicSize(Std.int(alex.width * daPixelZoom));
					add(alex);
				...
				switch (dad.curCharacter)
				{
					case 'senpai':
						...
						case 'notch':
							...
							camFollow.x = dad.getMidpoint().x - -370;
	...
	*/
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case 'notch':
				if(FlxG.save.data.distractions){
					alex.animation.play('idle', false);
				}
